...
cp "${ROOT_DIR}/README.md" "${DOCS_SRC_DIR}/index.md"
...
cp "${ROOT_DIR}/LICENSE" "${DOCS_SRC_DIR}/LICENSE"
cp "${ROOT_DIR}/CITATION.cff" "${DOCS_SRC_DIR}/CITATION.cff"
cp "${ROOT_DIR}/RIGHTS.md" "${DOCS_SRC_DIR}/RIGHTS.md"
